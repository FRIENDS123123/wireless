...
import { StyleSheet, Text, View , Button, TouchableOpacity, Image, TextInput, KeyboardAvoidingView} from 'react-native';
...
initiatBookIssue=async()=>{
    db.collection("transactions").add({
        ...
        'date':this.firebase.firestore.Timestamp.now().toDate(),
...
render(){
    ...
    return(
        <KeyboardAvoidingView style={styles.container} behavior="padding"enabled>
          ...
          style={{width:200,height:200}}/></View>
